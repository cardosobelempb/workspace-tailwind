  ...
  return (
    ...
    >
      <nav className="flex justify-between">
        ...
        <ul
          className={`fixed top-0 left-0 h-screen w-screen bg-df-golden flex flex-col gap-5 justify-center items-center scale-y-0 nav transition-transform duration-300 ease-in-out origin-bottom sm:static sm:scale-y-100 sm:flex-row sm:h-fit sm:w-auto sm:bg-transparent sm:p-0 z-30`}
        >
        ...
        <div
          className={`hamburger_tf sm:hidden flex flex-col gap-y-2.5 justify-center items-center z-50`}
        >
